    ...
    <main className="min-h-screen bg-[#171B1F] text-[#D9D9D9]">
      <section className="border-b border-[#384A59] bg-[#1D2328] px-6 py-16">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Badge variant="gold">
              {isLoading ? "Loading Licenses" : `${licenses.length} Active Licenses`}
            </Badge>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-16">
        <div className="mx-auto max-w-6xl">
          ...
          {isLoading ? (
            <div className="flex min-h-56 items-center justify-center border border-[#384A59] bg-[#1D2328]">
              <p className="text-sm uppercase tracking-[0.3em] text-[#99692E]">
                Loading License Registry
              </p>
            </div>
          ) : licenses.length === 0 ? (
            <div className="flex min-h-56 items-center justify-center border border-dashed border-[#384A59] bg-[#1D2328] px-6 text-center">
              <div>
          ...
          {errorMessage && (
            <div className="mt-8 border border-red-700 bg-red-900/20 px-5 py-4 text-sm text-red-400">
              Failed to load license directory: {errorMessage}
            </div>
          )}
